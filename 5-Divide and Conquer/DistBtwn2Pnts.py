...
def bruteForce(P, n):
	...
	return [min_val, (p1min.x,p1min.y), (p2min.x,p2min.y)]
...
P = [Point(2, 3), Point(12, 30),
	...
	Point(12, 10), Point(3, 4), Point(5, 4), Point(3, 9), Point(13, 14), Point(23, 44), Point(6, 5), Point(5, 2), Point(4, 4)]
n = len(P)
P1=list(P)

st=time.time()
print("(BruteForce) The smallest distance is",
				bruteForce(P, n))
et=time.time()
...
st1=time.time()
print("(Divide&Conquer) The smallest distance is",
				closest(P1, n))
et1=time.time()
